...
/**
 * 에러 응답 DTO GlobalExceptionHandler에서 사용하는 표준 에러 응답 형식
 *
 * @author AI Assistant
 * @since 2025-01-20
 */
...
public class ErrorResponse {
  ...
  public static ErrorResponse of(String code, String message, String detail) {
    return ErrorResponse.builder().code(code).message(message).detail(detail).build();
  }
  ...
  public static class FieldError {
    ...
    public static FieldError of(String field, String reason) {
      return FieldError.builder().field(field).reason(reason).build();
    }
