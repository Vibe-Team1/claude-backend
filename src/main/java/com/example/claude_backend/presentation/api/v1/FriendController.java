...
public class FriendController {
  ...
  @GetMapping("/users")
  public ResponseEntity<ApiResponse<List<SimpleUserResponse>>> getAllUsers(
  ...
  @GetMapping("/friends")
  public ResponseEntity<ApiResponse<List<SimpleUserResponse>>> getFriends(
      Authentication authentication) {
  ...
  public ResponseEntity<ApiResponse<Void>> addFriend(
      Authentication authentication, @Valid @RequestBody FriendRequest request) {
